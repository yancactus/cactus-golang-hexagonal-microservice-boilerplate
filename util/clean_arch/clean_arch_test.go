...
import (
	...
	"cactus-golang-hexagonal-microservice-boilerplate/util"
...
func TestParseLayerMetadata(t *testing.T) {
	testCases := []struct {
		...
		// domain layer
		{
			Path: "/cactus-golang-hexagonal-microservice-boilerplate/domain/file.go",
			ExpectedFileMetadata: LayerMetadata{
				Module: "domain",
				Layer:  LayerDomain,
			},
		...
		{
			Path: "/cactus-golang-hexagonal-microservice-boilerplate/domain/sub-package/file.go",
			ExpectedFileMetadata: LayerMetadata{
				Module: "domain",
				Layer:  LayerDomain,
			},
