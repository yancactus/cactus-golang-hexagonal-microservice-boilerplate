...
import (
	...
	"cactus-golang-hexagonal-microservice-boilerplate/util/errors"
...
func (m *MockTransaction) GetTx() interface{} {
	args := m.Called()
	return args.Get(0)
}
...
func TestNilFunctionHandling(t *testing.T) {
	...
	var fn func(context.Context, repo.Transaction) (any, error)
